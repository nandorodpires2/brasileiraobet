...
class Zend_View_Helper_Montante extends Zend_View_Helper_Abstract {
    ...
    public function montante($partida_id) {
        ...
        $porcentagem_banca = (int)Zend_Registry::get("config")->banca->porcentagem;
        
        $premio = ($partida->partida_valor * (int)Zend_Registry::get("config")->premio->fator) + $montante->montante;
